...
Funkcja Bohachevsky'ego I jest stosunkowo prost¹ do minimalizacji funkcja dwóch zmiennych, której wykres przedstawiony na rysunku \ref{wykres:img_boha} przybiera kszta³t ³uku. Z regu³y jest ona badana w zakresie $x_i \in[-100,100]$ dla $i=1,2$. W przedstawianej pracy magisterskiej granice to zosta³y jednak dwukrotnie powiêkszone i wynosz¹ $[-200,200]$. Wed³ug doœwiadczeñ przeprowadzonych w \cite{RankingFunkcjiTestowych}, $81.75\%$ prób zakoñczonych zosta³o znalezieniem minimum globalnego, które dla funkcji Bohachevsky'ego I wynosi $0$ w punkcie $x=(0,0)$.
...
\begin{figure}[tb]
    ...
    \caption{Wykres funkcji Ackleya dla dwóch zmiennych oraz ogólny wzór funkcji, ród³o: https://www.sfu.ca/\textasciitilde ssurjano/ackley.html}
...
\begin{figure}[tb]
    ...
    \caption{Wykres funkcji Rosenbrocka dla dwóch zmiennych oraz ogólny wzór funkcji, ród³o: https://www.sfu.ca/\textasciitilde ssurjano/rosen.html}
...
\begin{figure}[H]
    ...
    \caption{Wykres funkcji Griewanka dla dwóch zmiennych oraz ogólny wzór funkcji, ród³o: https://www.sfu.ca/\textasciitilde ssurjano/gri.html}
...
\begin{figure}[H]
    ...
    \caption{Zasada dzia³ania algorytmu symulowanego w poszukiwaniu maksimum funkcji, 
...
$p_i$ - prawdopodobieñstwa akceptacji

$\Delta_i$ – ró¿nica pomiêdzy wartoœciami najlepszego punktu oraz punktu w $i$-tej iteracji

$T_i$ – wartoœæ temperatury
\newline

W sytuacji, w której $\Delta_i$ i $T_i$ s¹ wartoœciami dodatnimi, $p_i$ przyjmuje wartoœci z zakresu $(0;\frac{1}{2}$. Ni¿sza temperatura prowadzi do mniejszego prawdopodobieñstwa zaakceptowania gorszego rezultatu. Podobnie jest z $\Delta$ – im wiêksza delta, tym mniejsza szansa na zaakceptowanie.
...
Zaprezentowane funkcje Resharpera wraz z innymi, które opisane zosta³y w odnoœniku \cite{ResharperFeatures}, umo¿liwi³y zmniejszenie czasu potrzebnego na implementacjê niezbêdnych w projekcie modu³ów poprzez zminimalizowanie liczby pojawiaj¹cych siê zagro¿eñ we wczesnej fazie pisania kodu oraz zautomatyzowanie powtarzalnych czynnoœci.  
...
W aspekcie programowania, podobnie jak w innych dziedzinach, w których przeprowadzana jest operacja budowy zadanego elementu, nale¿y dok³adnie zaplanowaæ jego proces. W aktualnym rozdziale przedstawiony zosta³ opis metodologii, który pozwoli³ na uporz¹dkowanie procesu budowania aplikacji komputerowej wraz z jego odmian¹, która zastosowana zosta³a podczas pracy nad prezentowan¹ prac¹ magistersk¹. W podpunkcie \ref{dzial:ModelAplikacji} zosta³ równie¿ zawarty szczegó³owy opis poszczególnych elementów ze strony projektu programistycznego, który to jest efektem pracy implementacyjnej.
...
Ca³y proces pocz¹wszy od pomys³u automatyzacji przeprowadzanych badañ zawarty w punkcie \ref{dzial:AutomatyzacjaPrzeprowadzanychBadan}, przez analizê rozwi¹zañ technologicznych opisanych w punkcie \ref{dzial:WykorzystaneRozwiazaniaTechnologiczne}, po budowê architektury oraz samej aplikacji bazodanowej ujêty w punkcie \ref{dzial:ArchitekturaBudowanejApl} mia³ za zadanie u³atwiæ przeprowadzenie eksperymentalnych badañ porównawczych wybranych algorytmów metaheurystycznych. W obecnym rozdziale przedstawiony zosta³ opis metod porównawczych, a tak¿e samych badañ doœwiadczalnych wraz z ich zagregowanymi wynikami zawartymi w podpunkcie \ref{dzial:WynikiDoswiadczenDlaZadanychFun}.
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników algorytmu genetycznego dla funkcji Bohachevsky’ego I - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:boh_ga_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Bohachevsky’ego I - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:boh_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie najlepszych wyników wszystkich trzech porównywanych algorytmów metaheurystycznych dla funkcji Bohachevsky’ego I - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:boh_all_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników algorytmu genetycznego dla funkcji Bohachevsky’ego I - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne., ród³o: Opracowanie w³asne.}
    \label{tab:boh_ga_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Bohachevsky’ego I - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:boh_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie najlepszych wyników wszystkich trzech porównywanych algorytmów metaheurystycznych dla funkcji Bohachevsky’ego I - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:boh_all_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Colville'a - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:col_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Colville'a - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:col_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników algorytmu genetycznego dla funkcji Ackleya - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:ack_ga_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Ackleya - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:ack_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie najlepszych wyników wszystkich trzech porównywanych algorytmów metaheurystycznych dla funkcji Ackleya - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:ack_all_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników algorytmu genetycznego dla funkcji Ackleya - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne., ród³o: Opracowanie w³asne.}
    \label{tab:ack_ga_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Ackleya - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:ack_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie najlepszych wyników wszystkich trzech porównywanych algorytmów metaheurystycznych dla funkcji Ackleya - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:ack_all_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Rosenbrocka - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:ros_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Rosenbrocka - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:ros_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Eggholdera - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:egg_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Eggholdera - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:egg_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Griewanka - kryterium czasowe, ród³o: Opracowanie w³asne.}
    \label{tab:gri_pso_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zestawienie wyników metody optymalizacji rojem cz¹stek dla funkcji Griewanka - kryterium liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:gri_pso_2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Ranking porównanych algorytmów heurystycznych (Algorytm genetyczny - GA; Metoda optymalizacji rojem cz¹stek - PSO; Algorytm symulowanego wy¿arzania - SA) dla wyników dotycz¹cych kryterium maksymalnego czasu, ród³o: Opracowanie w³asne.}
    \label{tab:results_1}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Ranking porównanych algorytmów heurystycznych (Algorytm genetyczny - GA; Metoda optymalizacji rojem cz¹stek - PSO; Algorytm symulowanego wy¿arzania - SA) dla wyników dotycz¹cych maksymalnej liczby odwo³añ do funkcji testowej, ród³o: Opracowanie w³asne.}
    \label{tab:results_2}
\end{table}
