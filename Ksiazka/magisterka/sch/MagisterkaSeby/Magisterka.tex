...
\begin{figure}[ht]
    ...
    \caption{Przestawienie czêœci bazy danych dotycz¹cej przeprowadzanych badañ, ród³o: Opracowanie w³asne.}
    \label{rys:baza_dane}
\end{figure} 
...
\subsubsection{Uruchomienie aplikacji bazodanowej}
...
\begin{figure}[ht]
    ...
    \caption{Widok na oko g³ówne aplikacji podczas przeprowadzania testów, ród³o: Opracowanie w³asne.}
    \label{rys:apka}
\end{figure} 
...
Molga M., Smutnicki C.,\textsl{Test functions for optimization needs}, 2005, http://www.zsd.ict.pwr.wroc.pl/files/docs/functions.pdf [dostêp 1.05.2017r. - 15.07.2017r.]
