...
W aspekcie grafiki, Matlab pozwala na rysowanie dwu oraz trójwymiarowych wykresów, a tak¿e wizualizacjê rezultatu obliczeñ w postaci animacji. 
...
W celu zrównania szans ka¿dego z porównywanych algorytmów, wszystkie przeprowadzane testy dokonywane bêd¹ na tej samej maszynie obliczeniowej przy tych samych warunkach obci¹¿eniowych systemu. Pierwszym kryterium porównawczym bêdzie maksymalny czas, w którym algorytm bêdzie poszukiwa³ najlepszego rezultatu. Parametr ten bêdzie bra³ pod uwagê kilka ró¿nych ustalonych wartoœci (TODO: podaæ czasy doœwiadczeñ) dla których przeprowadzona zostanie próbka doœwiadczeñ, z których wartoœci œrednie zostan¹ zestawione i porównane w obrêbie wszystkich algorytmów oraz funkcji testowych. Drugie kryterium porównawcze to liczba odwo³añ algorytmu do zadanej funkcji testowej. W kryterium tym porównane zostan¹, w sposób analogiczny jak w pierwszym kryterium, rezultaty otrzymane przez algorytmy przy takim za³o¿eniu, i¿ bêd¹ one mog³y wyliczyæ wartoœæ funkcji testowej okreœlon¹ liczbê razy.
