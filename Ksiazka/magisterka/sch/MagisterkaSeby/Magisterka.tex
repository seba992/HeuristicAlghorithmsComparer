...
Zastosowanie w projekcie bazy danych wymusi³o obowi¹zek utworzenia oraz uruchomienia serwera bazodanowego. Przez fakt na zastosowane technologie, których opis znajduje siê w rozdziale \ref{dzial:ZastosowaneTechnologie}, u¿yty zosta³ Microsoft SQL Server. Jest to relacyjny system zarz¹dzania baz¹ danych, którego podstawow¹ funkcj¹ jest przechowywanie i przetwarzanie danych na ¿¹danie innych aplikacji, które mog¹ dzia³aæ na tym samym komputerze lub na innym komputerze w sieci LAN czy te¿ WAN. Przydatnym narzêdziem przy pracy z Microsoft SQL Serverem jest dedykowane narzêdzie z graficznym interfejsem u¿ytkownika, który w znacznym stopniu upraszcza korzystanie z funkcji SQL serwera.
...
\bibitem{Mvvm} 
Petzold C.: \textsl{Windows 8. Programowanie aplikacji z wykorzystaniem C\# i XAML}, Wydawnistwo Helion, Gliwice 2013, str. 215-235
